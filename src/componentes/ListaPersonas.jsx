...
function ListaPersonas() {
    ...
    const eliminarPersona = (index) => {
        // Filtrar la lista de personas eliminando el elemento con el índice dado
        const personasActualizadas = personas.filter((_, i) => i !== index);
        setPersonas(personasActualizadas);

        // Si estamos editando el elemento que se elimina, salir del modo edición
        if (editIndex === index) {
            setNombre('');
            setApellido('');
            setEditIndex(null);
